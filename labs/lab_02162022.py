# #1. Declare a class called employee 
...
# #2. Create 2 instances of the bank class: Anna, Chase 



# #3. Create a constructor and define the following properties for the employee class: id, salary, department
...
# anna = Employee("AB042", 70000, "Sales")
# chase = Employee("CD069", 95000, "Legal")

# print(anna.id, anna.salary) #will print anna's ID and then her salary
# print(chase.department) #will print chase's department

# #4. Modify the Anna and Chase employee instances to pass initial data to the employee class. 
...
# #4a. Print the Anna's salary

# print(anna.salary)

# #4b. Print Chase's Salary 
...
# 2a. Instantiate an instance object of Person with name of 'Sonny', 
...
# 2b. Instantiate another person with the name of 'Jordan', 
...
# 2c. Have sonny greet jordan using the greet method.



# 2d. Have jordan greet sonny using the greet method.



# 2e. Write a print statement to print the contact info (email and phone) of Sonny.



# 2f. Write another print statement to print the contact info of Jordan.
